...
*/
  ...
  Handlebars.registerHelper("uif", function () {
    var options = arguments[arguments.length - 1];
    return Handlebars.helpers["u"].apply(this, arguments)
      ? options.fn(this)
      : options.inverse(this);
  });
  ...
  Handlebars.registerHelper("g", function () {
    ...
    if (typeof value != "undefined" && value !== null) {
      return typeof value == "function" ? value.apply({}, arguments) : value;
    } else {
  ...
  Handlebars.registerHelper("gif", function () {
    var options = arguments[arguments.length - 1];
    return Handlebars.helpers["g"].apply(this, arguments)
      ? options.fn(this)
      : options.inverse(this);
  });
